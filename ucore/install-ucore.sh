...
log "Installing cockpit-zfs-manager from latest github release"
CZM_TGZ_URL="$(
...
log "Installing cockpit-file-sharing from latest github release"
dnf install "$(
    curl --fail --retry 15 --retry-all-errors -sSL \
...
log "Installing xdg-ninja from latest github main branch"
...
log "Disable tuned service by default"
